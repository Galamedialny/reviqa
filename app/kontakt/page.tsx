...
export const metadata: Metadata = { title: "Kontakt", description: "Kontaktujte súkromné regeneračné centrum REVIQA na adrese Hitschova 5022/2, 058 01 Poprad, Slovakia." };
