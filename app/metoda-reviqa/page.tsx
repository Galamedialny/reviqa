...
export default function MethodPage() {
  return <><PageHero eyebrow="Metóda REVIQA" title="Päť krokov. Jeden individuálny príbeh." text="Metóda REVIQA je rámec personalizovanej starostlivosti. Nie je univerzálnym protokolom ani samostatnou liečbou – každý krok sa prispôsobuje potrebám klienta." image="/assets/reviqa-philosophy.jpeg" />
    <section className="section shell method-system"><SectionHeading eyebrow="Autorská metodika" title="REVIQA Method™ | Chironeurogenic System™" text="Naša autorská metodika spája biomechaniku, neuromyoskeletálnu manuálnu terapiu, fyzio-regeneračné postupy a moderné high-tech regeneračné technológie do jedného personalizovaného systému starostlivosti." /><div className="method-system-copy"><p>Nevyberáte si jednotlivé terapie. Na základe funkčného zhodnotenia vášho stavu spoločne vytvárame personalizovaný regeneračný protokol, ktorý rešpektuje vaše individuálne potreby, aktuálny funkčný stav a dlhodobé ciele.</p><p>Nasledujúcich päť krokov ukazuje, ako metodiku uplatňujeme v praxi – od prvého porozumenia až po dlhodobú podporu.</p></div></section>
